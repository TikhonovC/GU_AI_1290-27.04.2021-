# Задание 6
def int_func(text=''):
    """ Метод принимает на вход строку из букв латинского алфавита и пробелов
    ...
    try:
        ...
        for i in words:
            if 97 <= ord(i) <= 122 or ord(i) == 32:
                ...
                print(f"Ошибка обработки символа: '{i}' ({ord(i)}), проверьте, что используется только латиница и пробелы")
    except:
        print(f"Ошибка обработки строки")

    return summ_words.title()

print(int_func('q1у3q gg  h'))
